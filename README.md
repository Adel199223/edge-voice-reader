...
This repo is a lightweight MV3 extension that reads page blocks, selected text, and manual text with Microsoft Edge voices only.
...
- While reading, click another sentence or list item to jump forward from that exact point.
